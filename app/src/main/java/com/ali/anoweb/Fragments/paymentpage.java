...
import com.ali.anoweb.creditcardprice;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        checkBoxssb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (!isChecked){
                    Fragment fragment =getParentFragmentManager().findFragmentById(R.id.ssb);
        ...
        checkBoxcredit.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (!isChecked){
                    Fragment fragment =getParentFragmentManager().findFragmentById(R.id.credit);
                    getParentFragmentManager().beginTransaction().remove(fragment).commit();
                }
            }
        });
